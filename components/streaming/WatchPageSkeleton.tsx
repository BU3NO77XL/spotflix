...
export default function WatchPageSkeleton() {
  return (
    <div className="min-h-screen bg-[#121212]">
      ...
      <div className="relative h-[60vh] sm:h-[70vh] lg:h-[80vh] bg-[#1f1f1f] overflow-hidden">
        {/* Animated gradient background */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-[#1f1f1f] via-[#2a2a2a] to-[#1f1f1f]"
          animate={{
            x: ['-100%', '100%']
          }}
          transition={{
