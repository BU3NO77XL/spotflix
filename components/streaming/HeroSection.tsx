                        ...
                        >
                            ...
                            {rank && (
                                <motion.div variants={itemVariants} className="flex items-center">
                                    <svg width="245" height="30" viewBox="0 0 245 30" fill="none" aria-label={`#${rank} em ${movie.type === 'series' ? 'Séries' : 'Filmes'} hoje`}>
                                        ...
                                        <text x="35" y="21" fill="white" fontSize="17" fontWeight="400" fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif">#{rank} em {movie.type === 'series' ? 'Séries' : 'Filmes'} hoje</text>
                                    </svg>
                                </motion.div>
                            )}
