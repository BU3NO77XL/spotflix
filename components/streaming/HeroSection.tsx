                        ...
                        >
                            ...
                            {rank && (
                                <motion.div variants={itemVariants} className="flex items-center">
                                    <svg viewBox="0 0 245 30" fill="none" className="w-[160px] md:w-[220px] h-auto" aria-label={`#${rank} em ${movie.type === 'series' ? 'Séries' : 'Filmes'} hoje`}>
                                        ...
                                        <text x="35" y="21" fill="white" fontSize="17" fontWeight="700" fontFamily="'Netflix Sans'">#{rank} em {movie.type === 'series' ? 'Séries' : 'Filmes'} hoje</text>
                                    </svg>
                                </motion.div>
                            )}
