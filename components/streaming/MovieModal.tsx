                ...
                <>
                    ...
                    >
                        <div className="min-h-full">
                            {/* Header Image */}
                            <div className="relative h-48 sm:h-64 lg:h-80 flex-shrink-0">
                                <img
                         ...
                         text-white transition-colors w-9 h-9 flex items-center justify-center"
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-0 mb-8 sm:mb-12 lg:mb-16 px-4 sm:px-8 lg:px-12">
                            ...
                            <div className="px-4 sm:px-8 lg:px-12 py-3 sm:py-4 bg-gradient-to-b from-[#181818] to-[#181818]/90">
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                    ...
                                    <svg viewBox="0 0 58.07 24" className="w-[24px] sm:w-[30px] hidden sm:block">
