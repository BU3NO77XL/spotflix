            ...
            <section className="relative h-[70vh] sm:h-[75vh] lg:h-[80vh] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 px-4 sm:px-8 lg:px-12 pb-0 sm:pb-2 lg:pb-4">
                    <div className="max-w-4xl">
                        ...
                        {urlRank && (
                            <div className="flex items-center animate-in fade-in slide-in-from-left-4 duration-500 mt-3">
                                <svg width="245" height="30" viewBox="0 0 245 30" fill="none" aria-label={`#${urlRank} em ${movie.type === 'series' ? 'Séries' : 'Filmes'} hoje`}>
                                    ...
                                    <text x="9" y="24" fill="white" fontSize="13" fontWeight="900" fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif">{urlRank}</text>
                                    <text x="35" y="21" fill="white" fontSize="17" fontWeight="400" fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif">#{urlRank} em {movie.type === 'series' ? 'Séries' : 'Filmes'} hoje</text>
                                </svg>
                            </div>
                        )}
                    </div>
